...
$room_type = mysqli_real_escape_string($link, $_REQUEST['room_type']);
$price = mysqli_real_escape_string($link, $_REQUEST['price']);
$hotel_id = mysqli_real_escape_string($link, $_REQUEST['hotel_id']);

 
// attempt insert query execution
$sql = "INSERT INTO rooms (room_no,room_type,price,hotel_id) VALUES ('$room_no', '$room_type', '$price','$hotel_id')";
