...
Enter hotel ID: <input type="text" name="term" /><br />  
Enter supplier ID: <input type="text" name="term1" /><br /> 
...
$term1 = mysql_real_escape_string($_REQUEST['term1']);  
$field = mysql_real_escape_string($_REQUEST['field']);  
$value = mysql_real_escape_string($_REQUEST['value']); 

$query = "Update supplies set ".$field." = '".$value."' where hotel_id like '%".$term."%' and supplier_id like '%".$term1."%'";
