...
Enter department name: <input type="text" name="term" /><br />  
...
$query = "SELECT * FROM department WHERE dept_name LIKE '%".$term."%'"; 
$result = mysql_query($query); 

echo "<table >";
while($row = mysql_fetch_array($result)){   //Creates a loop to loop through results
echo "<tr><td>" . $row['dept_id'] . "</td><td>" . $row['dept_name']  . "</td><td>";  //$row['index'] the index here is a field name
}
}
