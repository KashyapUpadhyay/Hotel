...
Enter facility ID: <input type="text" name="term" /><br />  
...
$query = "SELECT * FROM provides WHERE f_id LIKE '%".$term."%'"; 
$result = mysql_query($query); 

echo "<table >";
while($row = mysql_fetch_array($result)){   //Creates a loop to loop through results
echo "<tr><td>" . $row['f_id'] . "</td><td>" . $row['hotel_id']  . "</td><td>";  //$row['index'] the index here is a field name
}
}
