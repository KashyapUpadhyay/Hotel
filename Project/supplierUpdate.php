...
$query = "Update supplier set ".$field." = '".$value."' where supplier_id like '%".$term."%'";
...
echo '<form action="Update.html">
    <input  style="background-color:#2cf422; height:50px;font-size:x-large" type="submit" value="Update Page" />
</form>' ; ;
?>
    </body>
</html>
