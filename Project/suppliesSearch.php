...
$query = "SELECT * FROM supplies WHERE supplier_id LIKE '%".$term."%'"; 
$result = mysql_query($query); 

echo "<table >";
while($row = mysql_fetch_array($result)){   //Creates a loop to loop through results
echo "<tr><td>" . $row['hotel_id'] . "</td><td>" . $row['supplier_id']  . "</td><td>" . $row['quantity'] ."</td><td>" . $row['price'] . "</td></tr>";  //$row['index'] the index here is a field name
}
}
